...
export default function Alert() {
  ...
  return (
    <div
      className={'text-gray-600 dark:text-gray-300 border-b bg-accent-1 border-accent-2 space-x-10 flex items-center justify-center'}
    >
      ...
      <div className="py-2 text-center text-sm">
        <button id="theme-toggle" type="button" onClick={handleClick} className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
